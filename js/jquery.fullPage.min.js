  ...
  b.fn.fullpage = function (c) {
    function pa(a) {
      ...
      "#fff" != c.controlArrowColor &&
        ...
        a
          ...
          .css(
            "border-color",
            "transparent " + c.controlArrowColor + " transparent transparent"
          ));
    ...
    function S() {
      ...
      if (!c.autoScrolling && !f.hasClass("active")) {
        ...
        m ||
          (b.isFunction(c.onLeave) && c.onLeave.call(this, ra, k, g),
    ...
    function V(a) {
      return (scrollable = a.find(".fp-slides").length
          ...
          if (
            ((c =
              "top" === c
                ? !d.scrollTop()
                : "bottom" === c
                ? d.scrollTop() + 1 + d.innerHeight() >= d[0].scrollHeight
                : void 0),
            c)
          )
            f();
    ...
    function sa(a) {
      ...
      if (!W(a.target)) {
        ...
        m ||
          ...
          (u = d.y),
          (A = d.x),
          a.find(".fp-slides").length && Math.abs(B - A) > Math.abs(v - u)
            ? Math.abs(B - A) >
                (b(window).width() / 100) * c.touchSensitivity &&
              (B > A
                ? l.right && b.fn.fullpage.moveSlideRight()
                : l.left && b.fn.fullpage.moveSlideLeft())
            : c.autoScrolling &&
              !c.scrollBar &&
              Math.abs(v - u) >
                (b(window).height() / 100) * c.touchSensitivity &&
              (v > u ? z("down", e) : u > v && z("up", e)));
      }
    }
    function W(a, d) {
      d = d || 0;
      var e = b(a).parent();
      return d < c.normalScrollElementTouchThreshold &&
        e.is(c.normalScrollElements)
        ? !0
        : d == c.normalScrollElementTouchThreshold
        ? !1
        : W(e, ++d);
    }
    function ta(a) {
    ...
    function r(a) {
      if (c.autoScrolling) {
        ...
        var d = Math.max(
          -1,
          Math.min(1, a.wheelDelta || -a.deltaY || -a.detail)
        );
        c.scrollBar &&
    ...
    function q(a, d, e) {
      ...
      if (
        ...
        !(
          (d.activeSection.is(a) && !x) ||
          (c.scrollBar && b(window).scrollTop() === d.dtop)
        ))
      ) {
        ...
        c.autoScrolling &&
          ...
          (d.isMovementUp
            ? b(".fp-section.active").before(
                d.activeSection.nextAll(".fp-section")
              )
            : b(".fp-section.active").after(
                d.activeSection.prevAll(".fp-section").get().reverse()
              ),
    ...
    function va(a) {
      ...
      c.autoScrolling && !c.scrollBar
        ? ((b.options = { top: -a.dtop }), (b.element = "." + ca))
    ...
    function wa(a) {
      a.wrapAroundElements &&
        ...
        (a.isMovementUp
          ? b(".fp-section:first").before(a.wrapAroundElements)
          : b(".fp-section:last").after(a.wrapAroundElements),
        n(b(".fp-section.active").position().top),
        Z());
    }
    function ba(a) {
      ...
      b.isFunction(c.afterLoad) &&
        !a.localIsResizing &&
        c.afterLoad.call(this, a.anchorLink, a.sectionIndex + 1);
      setTimeout(function () {
        m = !1;
    ...
    function w(a, d) {
      ...
      if (c.onSlideLeave) {
        ...
        q ||
          "none" === r ||
          (b.isFunction(c.onSlideLeave) &&
            c.onSlideLeave.call(this, l, k + 1, p, r));
      }
      d.addClass("active").siblings().removeClass("active");
      "undefined" === typeof m && (m = g);
      !c.loopHorizontal &&
        c.controlArrows &&
        (h.find(".fp-controlArrow.fp-prev").toggle(0 != g),
        h.find(".fp-controlArrow.fp-next").toggle(!d.is(":last-child")));
      h.hasClass("active") && I(g, m, l, k);
      var u = function () {
        q ||
          (b.isFunction(c.afterSlideLoad) &&
            c.afterSlideLoad.call(this, l, k + 1, m, g));
        t = !1;
      };
      c.css3
    ...
    function ga() {
      ...
      if (C) {
        if ("text" !== b(document.activeElement).attr("type")) {
          ...
          Math.abs(a - M) > (20 * Math.max(M, a)) / 100 &&
            (b.fn.fullpage.reBuild(!0), (M = a));
        }
      } else
        clearTimeout(ia),
      ...
      if (c.responsive) {
        ...
        b(window).width() < c.responsive
          ? a ||
            ...
            b("#fp-nav").hide(),
            g.addClass("fp-responsive"))
          : a &&
            (b.fn.fullpage.setAutoScrolling(N.autoScrolling, "internal"),
            b("#fp-nav").show(),
    ...
    function y(a) {
      ...
      b =
        h - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
      f > b
        ? e.length
          ? e
              .css("height", b + "px")
    ...
    function ka(a) {
      a.addClass("fp-table").wrapInner(
        '<div class="fp-tableCell" style="height:' + la(a) + 'px;" />'
      );
    }
    function la(a) {
      var b = h;
    ...
    function I(a, b, e, f) {
      ...
      c.anchors.length
        ? (a
            ? ("undefined" !== typeof e && (g = e),
              "undefined" === typeof b && (b = a),
              (K = b),
              na(g + "/" + b))
            : ("undefined" !== typeof a && (K = b), na(e)),
          D(location.hash))
        : "undefined" !== typeof a
        ? D(f + "-" + a)
        : D(String(f));
    ...
    function D(a) {
      a = a.replace("/", "-").replace("#", "");
      b("body")[0].className = b("body")[0].className.replace(
        /\b\s?fp-viewing-[^\s]+\b/g,
        ""
      );
    ...
    function za() {
      ...
      for (var f in c)
        void 0 !== a.style[f] &&
          ((a.style[f] = "translate3d(1px,1px,1px)"),
    ...
    function Aa() {
      ...
      O(g);
      O(g.find(".fp-easing"));
      g.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(
        function () {
    ...
    (function () {
      c.continuousVertical &&
        (c.loopTop || c.loopBottom) &&
        ((c.continuousVertical = !1),
        E(
          "warn",
    ...
    b.fn.fullpage.setAutoScrolling = function (a, d) {
      ...
      c.autoScrolling && !c.scrollBar
        ? (b("html, body").css({ overflow: "hidden", height: "100%" }),
          b.fn.fullpage.setRecordHistory(c.recordHistory, "internal"),
          g.css({ "-ms-touch-action": "none", "touch-action": "none" }),
          e.length && n(e.position().top))
        : (b("html, body").css({ overflow: "visible", height: "initial" }),
          b.fn.fullpage.setRecordHistory(!1, "internal"),
          g.css({ "-ms-touch-action": "", "touch-action": "" }),
          n(0),
    ...
    b.fn.fullpage.setMouseWheelScrolling = function (a) {
      a
        ? document.addEventListener
          ? (document.addEventListener("mousewheel", r, !1),
            document.addEventListener("wheel", r, !1))
          : document.attachEvent("onmousewheel", r)
        : document.addEventListener
        ? (document.removeEventListener("mousewheel", r, !1),
          document.removeEventListener("wheel", r, !1))
        : document.detachEvent("onmousewheel", r);
    };
        ...
        if ((b.fn.fullpage.setMouseWheelScrolling(!0), C || P))
          (MSPointer = oa()),
            b(document)
              ...
              .on("touchstart " + MSPointer.down, ta),
            b(document)
              .off("touchmove " + MSPointer.move)
              .on("touchmove " + MSPointer.move, sa);
      } else if ((b.fn.fullpage.setMouseWheelScrolling(!1), C || P))
        (MSPointer = oa()),
    ...
    b.fn.fullpage.moveSectionUp = function () {
      ...
      a.length ||
        (!c.loopTop && !c.continuousVertical) ||
        (a = b(".fp-section").last());
      a.length && q(a, null, !0);
    };
    b.fn.fullpage.moveSectionDown = function () {
      ...
      a.length ||
        (!c.loopBottom && !c.continuousVertical) ||
        (a = b(".fp-section").first());
      a.length && q(a, null, !1);
    };
    ...
    c.css3 && (c.css3 = za());
    b(this).length
      ? (g.css({ height: "100%", position: "relative" }), g.addClass(ca))
      : E(
          "error",
    ...
    b(".fp-section")
      .each(function (a) {
        ...
        (c.paddingTop || c.paddingBottom) &&
          b(this).css("padding", c.paddingTop + " 0 " + c.paddingBottom + " 0");
        "undefined" !== typeof c.sectionsColor[a] &&
          b(this).css("background-color", c.sectionsColor[a]);
        "undefined" !== typeof c.anchors[a] &&
          b(this).attr("data-anchor", c.anchors[a]);
        if (1 < f) {
          a = 100 * f;
          var g = 100 / f;
      ...
      .done(function () {
        ...
        a.length &&
          (0 != b(".fp-section.active").index(".fp-section") ||
            (0 == b(".fp-section.active").index(".fp-section") &&
              0 != a.index())) &&
          J(a);
        c.fixedElements && c.css3 && b(c.fixedElements).appendTo("body");
        c.navigation &&
          (k.css("margin-top", "-" + k.height() / 2 + "px"),
          k
            .find("li")
            .eq(b(".fp-section.active").index(".fp-section"))
            .find("a")
            .addClass("active"));
        c.menu &&
          c.css3 &&
          b(c.menu).closest(".fullpage-wrapper").length &&
          b(c.menu).appendTo("body");
        c.scrollOverflow
          ? ("complete" === document.readyState && R(), b(window).on("load", R))
          : b.isFunction(c.afterRender) && c.afterRender.call(this);
        ha();
        ...
        if (a.length) {
          ...
          !c.animateAnchor &&
            ...
            (c.autoScrolling
              ? n(d.position().top)
              : (n(0), D(a), b("html, body").scrollTop(d.position().top)),
            H(a, null),
            b.isFunction(c.afterLoad) &&
              c.afterLoad.call(this, a, d.index(".fp-section") + 1),
            d.addClass("active").siblings().removeClass("active"));
        }
    ...
    b(document).keydown(function (a) {
      if (
        c.keyboardScrolling &&
        c.autoScrolling &&
        ((40 != a.which && 38 != a.which) || a.preventDefault(), !m)
      )
        switch (a.which) {
          case 38:
          case 33:
    ...
    b.fn.fullpage.destroy = function (a) {
      ...
      b(document)
        ...
        .off("mouseover", c.normalScrollElements)
